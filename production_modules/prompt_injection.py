# Before the main classifier sees the user's ticket, use another LLM (“guard LLM”) to decide whether the text is a genuine support ticket or a prompt-injection attack.
...
GUARD_MODEL = os.getenv("DEFAULT_MODEL","openai/gpt-oss-120b")
...
def check_injection(text: str) -> InjectionCheckResult:
    ...
    """
    try:
        llm = ChatGroq(model=GUARD_MODEL, temperature=0)
